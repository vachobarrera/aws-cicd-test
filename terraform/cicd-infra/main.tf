...
# Code build to build the app ========================================================

resource "aws_codebuild_project" "mytest_codebuild" {
...
# Code pipeline to integrate code build and code deploy ========================================================
...
resource "aws_codepipeline" "mytest_pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ProjectName = "${var.project_name}_codebuild"
      }
    }
  }
